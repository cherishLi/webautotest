...
# 点击【变更优先级定义】
browser.find_element_by_id('menu_li_id').find_element_by_xpath('li[5]/ul[1]/li[6]/a[1]').click()
time.sleep(2)
# iframe切换
...
def editPriority():
    ...
    browser.find_element_by_id('formulaTable').find_element_by_xpath('tbody[1]/tr[1]/td[3]/select[1]/option[4]').click()
    browser.find_element_by_id('formulaTable').find_element_by_xpath('tbody[1]/tr[1]/td[3]/select[1]').click()
    time.sleep(1)
    result=browser.find_element_by_class_name('layui-layer-hui').find_element_by_xpath('div[1]').text
    if result == '保存成功':
        print('变更优先级修改成功')
        browser.find_element_by_id('formulaTable').find_element_by_xpath('tbody[1]/tr[1]/td[3]/select[1]/option[5]').click()
        browser.find_element_by_id('formulaTable').find_element_by_xpath('tbody[1]/tr[1]/td[3]/select[1]').click()
        time.sleep(2)
    else:
        print('变更优先级修改失败')
